...
After importing the ESG and GDP datasets, I created a subset of the data for all African countries.  These datasets were then grouped by African region, according to the United Nations classification of African countries. 

I then identified indicators from the ESG dataset that could be used to investigate each of the root causes.  Below is a table depicting the selected indicator(s):
![](/images/ReasonsInds.png)

## Unemployment Comparison
During the first round of analysis and visualisation I compared South African Unemployment to unemployment rates in the various regions as well as unemployment compared to other Southern African countries. 
![](/images/ReasonsInds.png)
Both of these graphs showed South Africa to have much higher unemployment rate than it's African counterparts. 
![](/images/UnemploymentRSA.png)

## Find the Top Ten Economies
Diving in a bit deeper, I decided to segment the data more and identify those African countries that has a closer resemblemce to South Africa.  Since South Africa has one of the largest economies in Africa, I used GDP size to isolate the largest ten economies on the continent.
...
## Associated Factors
To answer the questions above, we will look at the 6 reasons provided by the South African Government to explain unemployment levels based on the indicators chosen from the ESG dataset. We will investigate each of these as factors that can be associated with the very complex problem of unemployment. 
